...
export const ja: Resources = {
  analytics: {
    ...
    choice: 'アクセス解析の設定',
    off: 'オフ',
    offHint: 'このブラウザーから解析イベントを送信しません。',
    visit: '今回の訪問を測定',
    visitHint: '今回の訪問中のイベントを関連付けます。次回の訪問では識別しません。初期設定です。',
    browser: '再訪問の測定を許可',
    browserHint: '任意の設定です。ランダムなブラウザーIDを最大90日間使います。',
    blocked: 'Do Not TrackまたはGlobal Privacy Controlにより解析は無効です。',
    saved: '変更はすぐに適用されます。保存領域が利用できる場合、設定はこのブラウザーに保存されます。',
    collectTitle: '測定する情報',
    collect:
      'ページや流入元、キャンペーン、端末、ブラウザー、言語の分類、ゲームの進行、操作方法、生成結果、再試行、操作時間です。コントローラーの訪問はゲーム画面と区別します。',
    excludeTitle: '解析に送信しない情報',
    exclude:
      'プレイヤー名、入力したURL、取得したページ内容、ルームコード、接続用の秘密情報、端末の動き、IPアドレス、エラーメッセージ本文はPostHogへ送りません。画面録画、クリックの自動収集、広告追跡、フィンガープリントも行いません。',
    storageTitle: 'イベントの送信先',
    storage:
      'Cloudflareで検証したイベントを米国のPostHogへ送信します。訪問IDはセッション保存領域に置き、イベントが30分間なければ更新します。再訪問の測定を選ぶと、別のランダムIDを最大90日間ローカルに保存します。PostHogの無料プランではイベントを最大1年間保存します。IDの期限切れは過去のイベントを削除しません。',
    withdraw:
      'オフにすると今後の送信を停止し、ブラウザーIDと未送信イベントを消去します。今回の訪問を測定に変更すると永続IDを消去します。受信済みイベントは削除されません。質問や削除依頼は運営者へご連絡ください。',
    contact: '運営者へ連絡',
  },
  app: {
