/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 6d1bd1330fbe2c32c0b80afbe4252802)
...
interface __BaseEnv_Env {
	...
	ROOM_WS_LIMITER: RateLimit;
	BROWSER: BrowserRun;
	ASSETS?: Fetcher;
	CAPTURE_BACKEND: string;
	CAPTURE_SIDECAR_URL: string;
	DEV_ALLOWED_HOSTS: string;
	DOH_URL: string;
	WWM_ENV: string;
	BUILD_LIMIT_PER_HOUR: string;
	GLOBAL_BUILD_LIMIT_PER_HOUR: string;
	BROWSER_MAX_CONCURRENCY: string;
	CAPTURE_BUDGET_MS: string;
	SLICE0_BUDGET_MS: string;
	CACHE_TTL_DAYS: string;
	RETENTION_DAYS: string;
	CAPTURE_ENABLED: string;
	ROOM_STATS: string;
	TELEMETRY_INGEST: string;
	POSTHOG_HOST: string;
	POSTHOG_TOKEN: string;
	ANALYTICS_RELEASE: string;
	TELEMETRY_DEBUG: string;
	...
	BUILD_JOB: DurableObjectNamespace<import("./src/index").BuildJob>;
	LIMITER: DurableObjectNamespace<import("./src/index").Limiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Room" | "BuildJob" | "Limiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CAPTURE_BACKEND" | "CAPTURE_SIDECAR_URL" | "DEV_ALLOWED_HOSTS" | "DOH_URL" | "WWM_ENV" | "BUILD_LIMIT_PER_HOUR" | "GLOBAL_BUILD_LIMIT_PER_HOUR" | "BROWSER_MAX_CONCURRENCY" | "CAPTURE_BUDGET_MS" | "SLICE0_BUDGET_MS" | "CACHE_TTL_DAYS" | "RETENTION_DAYS" | "CAPTURE_ENABLED" | "ROOM_STATS" | "TELEMETRY_INGEST" | "POSTHOG_HOST" | "POSTHOG_TOKEN" | "ANALYTICS_RELEASE" | "TELEMETRY_DEBUG" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_ID" | "DOCENT_DAILY_LIMIT" | "DOCENT_PROVIDER" | "DOCENT_MODEL" | "DOCENT_MAX_TOKENS" | "DOCENT_LIMIT_PER_HOUR" | "DOCENT_CACHE_TTL_DAYS" | "DOCENT_MOCK_DELAY_MS">> {}
}
declare module "*.ttf" {
